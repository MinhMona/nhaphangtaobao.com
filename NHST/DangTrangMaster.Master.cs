...
namespace NHST
{
    public partial class DangTrangMaster : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrTel.Text += "<a href=\"tel:" + hotline + "\">" + hotline + "</a>";
                ltrMail.Text += "<a href=\"mailto:" + email + "\">" + email + "</a>";
                ltrCurrency.Text += "Tỉ giá: " + string.Format("{0:N0}", Convert.ToDouble(confi.Currency)) + "";
                ...
                ltrSocialfFooter.Text += "<li><a href=\"" + confi.Facebook + "\" target=\"_blank\"><i class=\"fa fa-facebook\" aria-hidden=\"true\"></i></a></li>";
                ltrSocialfFooter.Text += "<li><a href=\"" + confi.Twitter + "\" target=\"_blank\"><i class=\"fa fa-twitter\" aria-hidden=\"true\"></i></a></li>";
                ltrSocialfFooter.Text += "<li><a href=\"" + confi.YoutubeLink + "\" target=\"_blank\"><i class=\"fa fa-youtube-play\" aria-hidden=\"true\"></i></a></li>";
                ltrSocialfFooter.Text += "<li><a href=\"" + confi.Instagram + "\" target=\"_blank\"><i class=\"fa fa-instagram\" aria-hidden=\"true\"></i></a></li>";
                ltrSocialfFooter.Text += "<li><a href=\"" + confi.GooglePlus + "\" target=\"_blank\"><i class=\"fa fa-google-plus\" aria-hidden=\"true\"></i></a></li>";
            ...
            if (Session["userLoginSystem"] != null)
            {
                ...
                if (acc != null)
                {
                    ...
                    ltrLogin.Text += "<a class=\"acc-info-btn main-btn\" href=\"/thong-tin-nguoi-dung\"><i class=\"icon fa fa-user\"></i><span>" + username + "</span></a>";
