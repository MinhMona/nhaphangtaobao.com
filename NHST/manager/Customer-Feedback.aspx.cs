...
namespace NHST.manager
{
    public partial class Customer_Feedback : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            var la = TeamWorkController.GetBySQL_DK(3, page, 20);
            int total = TeamWorkController.GetTotalList(3);
            pagingall(la, total);
        }
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            string kq = TeamWorkController.InsertFeedback(txtFullName.Text, IMG, txtDescription.Text, username_current, DateTime.Now);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            var kq = TeamWorkController.Update(ID, EditFullName.Text, IMG, "", EditDescription.Text, Hide, username_current, DateTime.Now);
            if (Convert.ToInt32(kq) > 0)
            {
