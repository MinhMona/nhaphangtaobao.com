<%@ Page Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="TeamList.aspx.cs" Inherits="NHST.manager.TeamList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Thêm nhân viên</h4>
        ...
        <div class="row">
            ...
            <div id="modalEditStep" class="modal modal-fixed-footer">
                <div class="modal-hd">
                    ...
                    <h4 class="no-margin center-align">Thêm thông tin nhân viên</h4>
                </div>
                <div class="modal-bd">
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6">
                            <asp:TextBox runat="server" ID="txtPosition" placeholder="" type="text" class="validate" data-type="text-only"></asp:TextBox>
                            <label class="active" for="edit__step-name">Số điện thoại</label>
                        </div>
            ...
            <div id="modalEdit" class="modal modal-fixed-footer">
                ...
                <div class="modal-bd">
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            <asp:TextBox runat="server" ID="EditPosition" placeholder="" type="text" class="validate" data-type="text-only"></asp:TextBox>
                            <label class="active" for="edit__step-name">Số điện thoại</label>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function EditCustomer(ID) {
            $.ajax({
                type: "POST",
                url: "/manager/TeamList.aspx/loadinfo",
                data: '{ID: "' + ID + '"}',
                ...
                success: function (msg) {
                    ...
                    if (data != null) {
                        ...
                        $('#<%=EditPosition.ClientID%>').val(data.Description);
