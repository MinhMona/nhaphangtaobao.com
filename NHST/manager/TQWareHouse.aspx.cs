                                                    ...
                                                    if (setNoti.IsSendEmailUser == true)
                                                    {
                                                        try
                                                        {
                                                            PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", acc.Email,
                                                                "Thông báo tại NhapHangTaoBao.", "Hàng của đơn hàng " + MainorderID + " đã về kho TQ.", "");
                                                        }
                                                        catch { }
                                                    }
                                                }
                                ...
                                if (userRole == 0 || userRole == 2 || userRole == 4)
                                {
                                    if (!string.IsNullOrEmpty(Username))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (userkh != null)
                                            {
                                                string tID = TransportationOrderNewController.Insert(user.ID, username, "0", "0", "0", "0", "0", "0", "0",
