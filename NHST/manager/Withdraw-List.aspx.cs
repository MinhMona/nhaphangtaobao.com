                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        try
                                        {
                                            PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", user_rut.Email,
                                                "Thông báo tại NhapHangTaoBao.", "Admin đã duyệt lệnh rút tiền của bạn.", "");
                                        }
                                        catch { }
                                    }
                                }
                        ...
                        if (user_rut != null)
                        {
                            ...
                            if (setNoti != null)
                            {
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", user_rut.Email, "Thông báo tại NhapHangTaoBao.", "Admin đã hủy lệnh rút tiền của bạn.", "");
                                    }
                                    catch { }
                                }
                            }
