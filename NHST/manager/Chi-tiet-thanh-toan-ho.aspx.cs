                                    ...
                                    if (walletCYN > 0)
                                    {
                                        if (walletCYN >= TotalPrice)
                                        {
                                           ...
                                           8, currentDate, ac.Username, true);
                                                ...
                                                //    try
                                                //    {
                                                //        //PJUtils.SendMailGodaddy("vominhthien1688@gmail.com", "oiecjnsgwpsfgndz", usend.Email, "Thông báo đã hoàn thành thanh toán hộ tại vominhthien.com", "Yêu cầu thanh toán hộ của bạn đã hoàn thành tại vominhthien.com.", "");
                    ...
                    else
                    {
                       ...
                       8, currentDate, ac.Username, true);
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        ...
                                        {
                                            PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", usend.Email,
                                                "Thông báo tại NhapHangTaoBao.", "Đơn thanh toán hộ: " + ID + "  của bạn đã hoàn thành.", "");
                                        }
                                        catch { }
                                    }
                                }
