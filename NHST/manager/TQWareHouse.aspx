                    ...
                    <div class="filter">
                        <div class="select-bao">
                            <div class="input-field inline">
                                ...
                                <%--  <asp:DropDownList ID="ddlBigpackage" Visible="false" runat="server">
                                </asp:DropDownList>--%>
                                <%--  <select>
                        ...
                        <a href="javascript:;" onclick="UpdateAll()" style="display:none" class=" btn waves-effect modal-trigger mt-1">Cập nhật tất cả đơn</a>
        ...
        function printBarcode(barcode) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    html += "                        <th style=\"width:50%;padding:5px;border-right:1px solid rgba(0,0,0,0.5);border-top:1px solid rgba(0,0,0,0.5);border-bottom:1px solid rgba(0,0,0,0.5);\"><img style=\"width:20%;display:block;margin: 0 auto;padding: 10px 0;\" src=\"/App_Themes/NhapHangTaoBao/images/logo-export.png\" alt=\"\"></th>";
                    html += "                    </tr>";
                    html += "                   <tr>";
