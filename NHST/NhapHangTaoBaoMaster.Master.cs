...
namespace NHST
{
    public partial class NhapHangTaoBaoMaster : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrFooter.Text = confi.FooterLeft;
                //ftAddress.Text = confi.Address;

                ltrTel.Text += "<a href=\"tel:" + hotline + "\">" + hotline + "</a>";
                ltrEmail.Text += "<a href =\"mailto:" + email + "\">" + email + "</a>";
                //ftEmail.Text += "<a href=\"mailto:" + email + "\">" + email + "</a>";
                ltrCurrency.Text += "<div class=\"top-header-currency\">¥ " + string.Format("{0:N0}", Convert.ToDouble(confi.Currency)) + "</div>";
                ltrLogo.Text = "  <a href=\"/\" class=\"custom-logo-link\"><img src=\"" + confi.LogoIMG + "\" alt=\"\"></a>";
                //ftPhone.Text = " <a href=\"tel:" + hotline + "\">" + hotline + "</a>";
                ...
                //ltrSocialfFooter.Text += "<li><a href=\"" + confi.Facebook + "\"><img src=\"/App_Themes/NhapHangTaoBao/images/facebook.png\" alt=\"\"></a></li>";
                //ltrSocialfFooter.Text += "<li><a href=\"" + confi.Twitter + "\"><img src=\"/App_Themes/NhapHangTaoBao/images/twitter.png\" alt=\"\"></a></li>";            
                //ltrSocialfFooter.Text += "<li><a href=\"" + confi.Instagram + "\"><img src=\"/App_Themes/NhapHangTaoBao/images/instagram.png\" alt=\"\"></a></li>";
                //ltrSocialfFooter.Text += "<li><a href=\"" + confi.Skype + "\"><img src=\"/App_Themes/NhapHangTaoBao/images/skype.png\" alt=\"\"></a></li>";
            ...
            {
                ltrLogin.Text = "<div class=\"login-register\"><a href=\"/dang-nhap\">Đăng nhập</a> | <a href=\"/dang-ky\">Đăng ký</a></div>";
            }
        }
    }
}